...
class Listener(StreamListener):
    ...
    def on_data(self,data):
        try:
            ...
            logging.basicConfig(filename='isis_isil_velocity.log',format = '%(asctime)-15s %(message)s',level=logging.INFO)
            if Listener.counter == 5000:
                print "Exiting"
                exit()
...
twitterStream.filter(track =['isis','isil'])
